...
public class RetrieveLocationRelationApiController implements RetrieveLocationRelationApi {
    ...
    public ResponseEntity<RetrieveLocationRelation> createRetrieveLocationRelation(@ApiParam(value = "The Retrieve Location Relation to be created" ,required=true )  @Valid @RequestBody RetrieveLocationRelationCreate retrieveLocationRelation) {
