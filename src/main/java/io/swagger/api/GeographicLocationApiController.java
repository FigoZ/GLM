...
import io.swagger.service.GeographicLocationServiceImpl;
...
public class GeographicLocationApiController implements GeographicLocationApi {
    ...
    @Autowired
    private GeographicLocationServiceImpl<GeographicLocation> retriveGL;
    ...
    public ResponseEntity<List<GeographicLocation>> listGeographicLocation
        (
         ...
         @ApiParam(value = "For filtering: A string. Accuracy of the coordinate specified.")
         @Valid @RequestParam(value = "geographicPoint.accuracy", required = false) String geographicPointAccuracy,
         @ApiParam(value = "For filtering: A string. Geocoding referential.")
         @Valid @RequestParam(value = "geographicPoint.spatialRef", required = false) String geographicPointSpatialRef,
         @ApiParam(value = "For filtering: A string. x coordinate (usually latitude).")
         @Valid @RequestParam(value = "geographicPoint.x", required = false) String geographicPointX,
         @ApiParam(value = "For filtering: A string. y coordinate (usually longitude).")
         @Valid @RequestParam(value = "geographicPoint.y", required = false) String geographicPointY,
         @ApiParam(value = "For filtering: A string. z coordinate (usually elevation).")
         @Valid @RequestParam(value = "geographicPoint.z", required = false) String geographicPointZ
        ) {
    ...
    public ResponseEntity<List<GeographicLocation>> retrieveGeographicLocation(@ApiParam(value = "Identifier of the Geographic Location",required=true) @PathVariable("id") String id) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<GeographicLocation>>(retriveGL.findById(id),HttpStatus.OK);
              //  return new ResponseEntity<List<GeographicLocation>>(objectMapper.readValue("[ {  \"name\" : \"name\",  \"geographicPoint\" : [ {    \"spatialRef\" : \"spatialRef\",    \"x\" : \"x\",    \"accuracy\" : \"accuracy\",    \"y\" : \"y\",    \"z\" : \"z\"  }, {    \"spatialRef\" : \"spatialRef\",    \"x\" : \"x\",    \"accuracy\" : \"accuracy\",    \"y\" : \"y\",    \"z\" : \"z\"  } ],  \"id\" : \"id\",  \"href\" : \"href\",  \"type\" : \"type\"}, {  \"name\" : \"name\",  \"geographicPoint\" : [ {    \"spatialRef\" : \"spatialRef\",    \"x\" : \"x\",    \"accuracy\" : \"accuracy\",    \"y\" : \"y\",    \"z\" : \"z\"  }, {    \"spatialRef\" : \"spatialRef\",    \"x\" : \"x\",    \"accuracy\" : \"accuracy\",    \"y\" : \"y\",    \"z\" : \"z\"  } ],  \"id\" : \"id\",  \"href\" : \"href\",  \"type\" : \"type\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (Exception e) {
                log.error("Couldn't serialize response for content type application/json", e);
                return new ResponseEntity<List<GeographicLocation>>(HttpStatus.INTERNAL_SERVER_ERROR);
